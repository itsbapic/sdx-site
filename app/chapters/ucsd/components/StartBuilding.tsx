...
/** Match AsciiButton height: text-xs + py-3 ≈ 40px */
const iconBtn =
  'btn-outline-glow !w-10 !h-10 !min-w-10 !p-0 !px-0 !py-0 rounded-sm inline-flex items-center justify-center shrink-0';

export default function StartBuilding() {
  return (
    <section
      id="join"
      className="relative overflow-hidden min-h-[70svh] flex items-center justify-center px-4 sm:px-6 lg:px-8 text-center"
    >
      {/* Prismatic field with soft top/bottom fades into the page */}
      <div
